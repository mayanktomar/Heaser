...
export class ViewEmp extends Component {
    ...
    onDelete=async ()=>{
        ...
        await axios.delete('/employee/delete-employee/'+this.state.id)
        .then( (response)=> {
            const data = [...this.state.employees];

            const index = data.findIndex((item) => item._id == this.state.id);
                ...
                <div>
                    <div className="row" style={{margin:'0px'}}>
                        ...
                        <div className="col-md-3">
                            <Button id={e._id} style={{backgroundColor:'#dc3545',color:'white'}}
                            onClick={async()=>{
                                await this.setState({
                                    id:e._id,
        ...
        return (
            ...
            <div className="container empview">
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody>Are you sure to remove this employee?</ModalBody>
                    <ModalFooter>
