    ...
    render() {
        return (
            <div className="container empmain">
               ...
               <WelcomeModal isWelModalOpen={this.state.isWelModalOpen} toggleWelModal={this.toggleWelModal}/>
               <div className="row">
                   <div className="col-md-12">
                       <Card className="timecard">
                           <CardBody>
                               <h6 style={{fontWeight:'bold'}}>It is {moment(this.state.datetime).format('MMMM Do YYYY, h:mm:ss a')}</h6>
                           </CardBody>
                       </Card>
                       </div> 
